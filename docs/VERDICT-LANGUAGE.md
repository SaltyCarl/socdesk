...
— Generated by SOCDesk <timestamp / tz>. Sources queried <time>.
```
...
dual-use traffic; confirm relevance before acting.` Never "this IP is
malicious." A count + attributed evidence + recommended verification. Reads
urgent, survives a client reading it.
